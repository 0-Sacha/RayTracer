...
------ Path ------
project_outputdir = "%{cfg.system}-%{_ACTION}/%{cfg.buildcfg}-%{cfg.architecture}"
project_targetdir = "%{wks.location}/bin/" .. project_outputdir
project_objdir = "%{wks.location}/bin-int/" .. project_outputdir

-- Deprecated // Backwardompatibility--
...
--     system "windows"
--     defines "BASE_PLATFORM_WINDOWS"
--     print("Set Platform Windows")
-- 
-- filter "system:Unix"
--     system "linux"
--     defines "BASE_PLATFORM_LINUX"
--     print("Set Platform Linux")
-- 
-- filter "system:Mac"
--     system "macosx"
--     defines "BASE_PLATFORM_MACOS"
--     print("Set Platform Macos")
